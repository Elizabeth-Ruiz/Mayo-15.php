...
<ol>
<img src="images/cantidad_academicos.png" class="img-responsive">
<?php
for ($c = 0; $c < $all; $c++) {
...
<ol>
  <img src="images/actividad_academica.png" class="img-responsive">
<?php
for ($d = 0; $d < $all; $d++) {
...
<ol>
  <img src="images/actividad_sostenida_horas.png" class="img-responsive">
<?php
for ($d = 0; $d < $all; $d++) {
...
<p>El promedio de horas que cada docente destina a sus actividades en la Universidad de Chile es de <strong>24 horas.</strong></p>
  <img src="images/horas_actividad_docente.png" class="img-responsive">
